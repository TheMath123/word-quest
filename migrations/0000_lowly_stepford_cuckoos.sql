...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `alphabets_name_unique` ON `alphabets` (`name`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `authenticator_credentialID_unique` ON `authenticator` (`credentialID`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `game_data_user_id_unique` ON `game_data` (`user_id`);
--> statement-breakpoint
